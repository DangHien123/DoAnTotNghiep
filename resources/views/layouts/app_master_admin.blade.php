...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="{{ route('admin.static.index') }}" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ pare_url_file(get_data_user('admins', 'avatar')) }}" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">{{ get_data_user('admins', 'name') }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="{{ pare_url_file(get_data_user('admins', 'avatar')) }}" class="img-circle elevation-2" alt="User Image">
                            <p>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{ route('admin.statistical') }}" class="brand-link navbar-info">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ pare_url_file(get_data_user('admins', 'avatar')) }}" class="img-circle elevation-2"
                        ...
                        @if (in_array($level, $item['level']))
                            <li
                                ...
                                <a href="{{ isset($item['sub']) ? '#' : route($item['route']) }}"
                                    class="nav-link {{ in_array(Request::segment(2), $item['list-check']) ? ' active' : '' }}">
                                            ...
                                            @if (in_array($level, $li['level']))
                                                <li
                                                    ...
                                                    <a href="{{ route($li['route']) }}"
                                                        class="nav-link {{ Request::segment(2) == $li['namespace'] ? 'active' : '' }}">
        ...
        <footer class="main-footer">
            <strong>Đồ Án Tốt Nghiệp 2024 <a href="#">Nguyễn Đăng Hiện</a>.</strong>
            All rights reserved.
