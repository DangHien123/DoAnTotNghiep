        ...
        <div class="container header-wrapper">
            ...
            <div class="logo">
                <a href="/" class="desktop">
                    <img src="{{ url('images/logo.svg') }}" style="height: 35px;" alt="Home">
                </a>
                <span class="menu js-menu-cate"><i class="fas fa-bars"></i></span>
            </div>
            <div class="search">
                ...
                <form action="{{ $link_search ?? route('get.product.list',['k' => Request::get('k')]) }}" role="search" method="GET">
                    ...
                    <button type="submit" class="btnSearch" style="background: {{ config('layouts.component.menu.background') }};border:none;">
