            ...
            <div class="customer">
                ...
                <div class="customer__content">
                    <form class="from_cart_register" action="{{ route('post.shopping.pay') }}" method="post">
                        ...
                        <div class="btn-buy">
                            <button class="buy1 btn btn-purple {{ \Auth::id() ? '' : 'js-show-login' }}" style="width: 100%" type="submit" name="payment" value="1">
                                Thanh toán khi nhận hàng
                            </button>
                            <button class="buy1 btn btn-primary {{ \Auth::id() ? '' : 'js-show-login' }}" style="width: 100%;margin-top: 20px" type="submit" name="payment" value="2">
                                Thanh toán Online
                            </button>
                        </div>
                    </form>
            ...
            $('#province').on('change', function(e) {
                ...
                $.get('/get-state-list?provinceid=' + provinceid, function(data) {
                    ...
                    $.each(data, function(index, regenciesObj) {
                        $('#district').append('<option value="' + regenciesObj.id +
                            '">' + regenciesObj.name + '</option>');
                    })
                });
            });
        });
