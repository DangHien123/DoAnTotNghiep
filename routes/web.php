...
Route::group(['namespace' => 'Frontend'], function() {
    ...
    Route::get('/get-state-list',[ShoppingCartController::class,'getStateList']);
    Route::prefix('shopping')->group(function () {
        ...
        Route::get('api/v1/cities/search', [ShoppingCartController::class,'search_province'])->name('api.cities.search');
    });
    //Comment
